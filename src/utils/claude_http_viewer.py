...
from src.utils.claude_http_trace import SSEReassembler, normalize_usage

TRACE_VIEWER_VERSION = "web-coding-agent"

# Threshold: traces with more entries than this use lazy mode
LAZY_THRESHOLD = 50
VIEWER_TEMPLATE_PATH = Path(__file__).parent / "claude_http_viewer.html"
VIEWER_I18N_PATH = Path(__file__).parent / "claude_http_viewer_i18n.json"
...
def _viewer_i18n_script() -> str:
    ...
    return f"const __TRACE_VIEWER_I18N__ = {payload};\n"
...
def _generate_html_viewer(trace_path: Path, html_path: Path) -> None:
    ...
    version_js = json.dumps(TRACE_VIEWER_VERSION)
    ...
    if use_lazy:
        ...
        data_js = (
            ...
            f"const __TRACE_VIEWER_VERSION__ = {version_js};\n"
        )
